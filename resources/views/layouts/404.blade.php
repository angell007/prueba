  ...
  <div id="wrapper">
    ...
    <ul class=" navbar-nav sidebar sidebar accordion" id="accordionSidebar">
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3">O Sistemica</div>
      </a>
      <hr class="sidebar-divider my-0">
      <li class="nav-item">
        <a class="nav-link" href="index.html">
          <i class="text-primary fas fa-fw fa-tachometer-alt"></i>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTable" aria-expanded="true"
          ...
          <i class="text-primary fas fa-fw fa-table"></i>
          <span>Tables</span>
        </a>
      ...
      <li class="nav-item">
        <a class="nav-link" href="ui-colors.html">
          <i class="text-primary fas fa-fw fa-palette"></i>
          <span>UI Colors</span>
        </a>
      </li>
      <hr class="sidebar-divider">
      ...
      <li class="nav-item active">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsePage" aria-expanded="true"
          ...
          <i class="text-primary fas fa-fw fa-columns"></i>
          <span>Pages</span>
        </a>
      ...
      <li class="nav-item">
        <a class="nav-link" href="charts.html">
          <i class="text-primary fas fa-fw fa-chart-area"></i>
          <span>Charts</span>
        </a>
      </li>
      <hr class="sidebar-divider">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      <div id="content">
        <!-- TopBar -->
        <!-- Color de nav  -->
        <nav class="navbar navbar-expand navbar-dark bg-light topbar mb-4 static-top">
          ...
          <ul class="navbar-nav ml-auto">
                  ...
                  <div class="input-group">
                    ...
                    <div class="input-group-append">
                      <button class="btn btn-primary" type="button">
                        <i class="text-primary fas fa-search fa-sm"></i>
                      </button>
                    </div>
                  </div>
                </form>
                ...
                <a class="dropdown-item d-flex align-items-center" href="#">
                  <div class="mr-3">
                    <div class="icon-circle bg-primary">
                      <i class="text-primary fas fa-file-alt text-primary"></i>
                    </div>
                  </div>
                  <div>
                ...
                <a class="dropdown-item d-flex align-items-center" href="#">
                  <div class="mr-3">
                    <div class="icon-circle bg-success">
                      <i class="text-primary fas fa-donate text-primary"></i>
                    </div>
                  </div>
                  <div>
                ...
                <a class="dropdown-item d-flex align-items-center" href="#">
                  <div class="mr-3">
                    <div class="icon-circle bg-warning">
                      <i class="text-primary fas fa-exclamation-triangle text-primary"></i>
                    </div>
                  </div>
                  <div>
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
                ...
                <span class="ml-2 d-none d-lg-inline text-primary small">Maman Ketoprak</span>
              </a>
